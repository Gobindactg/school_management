        ...
        <div class="row">
            <div class="col-md-12 card-body card " id="section1" class="container-fluid bg-success text-white hidden" style="margin-top:20px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student Roll" name="student_roll">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-primary">Student Name <span style="color:red"> *</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student name" name="student_name">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-primary">Religion <span style="color:red"> *</span></label>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student Birth" name="student_birth">
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student Birth Registation Number" name="student_birth_number">
                </div>
            ...
            <div class="col-md-12 card-body card" id="section2" class="container-fluid bg-warning" style="margin-top:20px; display:none;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student Father Name" name="f_name">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-primary">Mother Name <span style="color:red"> *</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Student Mother Name" name="m_name">
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-primary">Father NID <span style="color:black">(Optional)</span></label>
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Father NID Number" name="f_nid">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-primary">Mother NID <span style="color:black">(Optional)</span></label>
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Mother NID Number" name="m_nid">
                </div>
