...
@section('content')
    <div class="container my-2">
        <div class="row">
            ...
            <div class="col-md-3">
                <select class="form-select " id="select_group" name="group">
                    <option selected value="null">-- Select Student Group --</option>
            ...
            <div class="col-md-3">
                <input type="submit" value="Search" id="submit_query" class="btn btn-info w-100">
            </div>
        </div>

    </div>

    <button class="btn btn-info " style="width: 100px" type="submit">Print</button>
    <div class="row">
        @foreach ($marks as $mark)
            <div class="col-md-12 card card-body">
                @foreach (App\Models\student_mark::institution() as $institution)
                    <h2 class="text-primary text-center" style="padding-top: 10px">
                        <strong>{{ $institution->name }}</strong>
                    </h2>
                    <h4 class="text-center "><strong> {{ $institution->address }},
                            {{ $institution->upazila->name }},{{ $institution->district->name }},
                            {{ $institution->division->name }} </strong></h4>
                    <h2 class="text-primary text-center border" style="font-family: tahoma; font-style:italic"><strong>ADMIT
                            CARD</strong></h2>
                @endforeach
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p style="font-size: 18px"><strong>Father's Name :</strong>
                            {{ $mark->student_info->father_name }}
                        </p>
                        <p style="font-size: 18px"><strong>Mother's Name :</strong>
                            {{ $mark->student_info->mother_name }}
                        </p>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 text-center">
                        <img src="{{ asset('Frontend/resources/img/profile-img.jpg') }}" alt=""
            ...
            $("#submit_query").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        //         "<th style='width:25%'>" + element.exam_title +
                        //         "</th>" +
                    ...
                    error: function(xhr, ajaxOptions, error_message) {
                        toastr.error('Something is went wrong. Please try again.');
                    }
                });
            });
        });
