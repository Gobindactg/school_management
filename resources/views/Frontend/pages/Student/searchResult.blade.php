    ...
    <table class="table table-bordered text-center">
        <thead>
            <tr>
                ...
                <th>Year</th>
                <th>Name</th>
                <th colspan="3" style="width:100px;">Action(Click Aditional Sub:)</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr style="padding:0; margin:0">
                ...
                <form action="{{ route('singleResult', $marks->id) }}" method="get" target="_blank">
                    <td style="padding:0; margin:0" class="text-center hover">
                        <input type="checkbox" id="add_subject" name="add_subject" value="add_subject" style="font-size:20px; padding-left:5px">
                        <button type="submit" target="_blank" class="btn btn-primary">View <a>
                ...
                <form action="{{ route('singleResultPDF', $marks->id) }}" method="get" target="_blank">



                    <td style="padding:0; margin:0" class="text-center hover">
                        <input type="checkbox" id="add_subject" name="add_subject" value="add_subject" style="font-size:20px">
                        <button type="submit" target="_blank" class="btn btn-primary ">Print<a>
                                <input type="hidden" value="{{$marks->class}}" name="class">
                                <input type="hidden" value="{{$marks->st_group}}" name="group">
                                <input type="hidden" value="{{$marks->st_year}}" name="year">
