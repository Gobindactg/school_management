    ...
    @foreach ($marks as $mark)
        <div class="col-md-12 card card-body">
            ...
            @foreach (App\Models\student_mark::institution() as $institution)
                <h2 class="text-primary text-center" style="padding-top: 10px"><strong>{{ $institution->name }}</strong>
                </h2>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p style="font-size: 18px"><strong>Mother's Name :</strong> {{ $mark->student_info->mother_name }}
                    </p>
                </div>
                <div class="col-md-3">
