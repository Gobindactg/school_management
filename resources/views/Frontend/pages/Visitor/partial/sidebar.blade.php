    ...
    <ul class="sidebar-nav " id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#instution" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Notices</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="instution" class="nav-content collapse text_color" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('institution') }}">
                        <i class="bi bi-circle"></i><span>Exam Notices</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manage.institution') }}">
                        <i class="bi bi-circle"></i><span>Admission Notices</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#teacher" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>School Result</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="teacher" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('teacher') }}">
                        <i class="bi bi-circle"></i><span>First Terminal</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manage.teacher') }}">
                        <i class="bi bi-circle"></i><span>Second Terminal</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manage.teacher') }}">
                        <i class="bi bi-circle"></i><span>Annual Exam</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#student" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Online Class</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="student" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('student') }}">
                        <i class="bi bi-circle"></i><span>Live Class</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manage.student') }}">
                        <i class="bi bi-circle"></i><span>Recorded Class</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manage.student') }}">
                        <i class="bi bi-circle"></i><span>Other Class</span>
                    </a>
                </li>
            </ul>
        </li>
