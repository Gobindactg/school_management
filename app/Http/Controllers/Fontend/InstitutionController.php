...
class InstitutionController extends Controller
{
    public function addInstution(){
        ...
        return view('Fontend.pages.Institution.instution')->with('district', $district)->with('division', $division);
        
    }
    public function manageInstitution(){
        $id = Auth::id();
        $institution = Institution_info::orderBy('id', 'desc')->where('user_id', $id)->get();
        return view('Fontend.pages.Institution.manageInstitution')->with('institution', $institution);
    }
